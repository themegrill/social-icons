<tr>
	...
	<td class="social_url"><input type="text" class="input_text" placeholder="<?php esc_attr_e( "http://", 'social-icons' ); ?>" name="_si_icon_urls[]" value="<?php echo esc_attr( $icon['url'] ); ?>" /></td>
